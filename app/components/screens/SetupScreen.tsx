...
export default function SetupScreen({ onNavigate }: SetupScreenProps) {
  ...
  return (
    <div className="min-h-screen pb-20">
      {/* Header */}
      <section className="pt-24 pb-12 bg-gradient-to-br from-blue-600 to-cyan-500">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-8">
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            >
              <div className="flex items-start gap-4 mb-6">
                <div className="w-14 h-14 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-xl flex items-center justify-center flex-shrink-0 shadow-lg shadow-blue-500/25">
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <h4 className="font-semibold text-slate-900">Target Setup</h4>
                ...
                <div className="space-y-4">
                  <h4 className="font-semibold text-slate-900">Recording Setup</h4>
                  <ul className="space-y-2 text-sm text-slate-600">
                    <li className="flex items-start gap-2">
            ...
            >
                  ...
                  <motion.div
                    ...
                    className={`flex items-center gap-4 p-4 rounded-xl cursor-pointer transition-all duration-200 ${
                      checkedItems.includes(item)
                        ...
                        : 'bg-slate-50 border-2 border-slate-100 hover:border-blue-200'
                    }`}
                  >
                    ...
                    <span className={`font-medium ${
                      checkedItems.includes(item) ? 'text-green-800' : 'text-slate-700'
                    }`}>
                      {item}
                    </span>
                  </motion.div>
              ...
              {allChecked && (
                <motion.div
                  ...
                  className="mt-6 p-4 bg-green-100 text-green-800 rounded-xl text-center font-semibold"
                >
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-amber-700">Use pre-recorded sample videos</p>
                  </div>
                </div>
                <button
          ...
          <div className="space-y-6">
            ...
            >
              <h3 className="text-lg font-bold text-slate-900 mb-6">Required Materials</h3>
              <div className="space-y-4">
                {materials.map((material, index) => (
                  ...
                  >
                    <div className="w-10 h-10 bg-blue-50 rounded-lg flex items-center justify-center">
                      <material.icon className="w-5 h-5 text-blue-600" />
                    </div>
                    <div className="flex-1">
                      <span className="text-sm font-medium text-slate-700">{material.label}</span>
                      {material.required && (
            ...
            >
              <h3 className="text-lg font-bold mb-4">Digital Target Setup</h3>
              <div className="aspect-square bg-slate-800 rounded-xl mb-4 relative overflow-hidden font-mono text-xs">
                <div className="absolute top-2 left-2 right-2 text-center text-slate-400">
                  [Recording Phone - Macro Mode]
                </div>
                <div className="absolute top-8 left-1/2 -translate-x-1/2 text-slate-500">
                  ↓ 15-20cm ↓
                </div>
                <div className="absolute top-16 left-1/2 -translate-x-1/2 w-20 h-20 bg-slate-700 rounded border-2 border-blue-500 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <span className="text-[10px] text-slate-400">2cm × 2cm</span>
                  </div>
                </div>
        ...
        >
          <motion.button
            ...
            className="group px-10 py-5 bg-gradient-to-r from-blue-600 to-cyan-500 text-white font-bold text-lg rounded-xl shadow-xl shadow-blue-500/25 flex items-center gap-3 mx-auto"
            whileHover={{ 
              scale: 1.05, 
